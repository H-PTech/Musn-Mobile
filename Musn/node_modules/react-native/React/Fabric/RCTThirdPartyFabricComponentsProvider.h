...
Class<RCTComponentViewProtocol> RNCNaverMapArrowheadPathCls(void) __attribute__((used)); // 0
Class<RCTComponentViewProtocol> RNCNaverMapCircleCls(void) __attribute__((used)); // 0
Class<RCTComponentViewProtocol> RNCNaverMapGroundCls(void) __attribute__((used)); // 0
Class<RCTComponentViewProtocol> RNCNaverMapMarkerCls(void) __attribute__((used)); // 0
Class<RCTComponentViewProtocol> RNCNaverMapPathCls(void) __attribute__((used)); // 0
Class<RCTComponentViewProtocol> RNCNaverMapPolygonCls(void) __attribute__((used)); // 0
Class<RCTComponentViewProtocol> RNCNaverMapPolylineCls(void) __attribute__((used)); // 0
Class<RCTComponentViewProtocol> RNCNaverMapViewCls(void) __attribute__((used)); // 0
#endif
