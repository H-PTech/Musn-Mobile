...
Class<RCTComponentViewProtocol> RCTThirdPartyFabricComponentsProvider(const char *name) {
  static std::unordered_map<std::string, Class (*)(void)> sFabricComponentsClassMap = {
    ...
    {"RNCNaverMapArrowheadPath", RNCNaverMapArrowheadPathCls}, // 0

    {"RNCNaverMapCircle", RNCNaverMapCircleCls}, // 0

    {"RNCNaverMapGround", RNCNaverMapGroundCls}, // 0

    {"RNCNaverMapMarker", RNCNaverMapMarkerCls}, // 0

    {"RNCNaverMapPath", RNCNaverMapPathCls}, // 0

    {"RNCNaverMapPolygon", RNCNaverMapPolygonCls}, // 0

    {"RNCNaverMapPolyline", RNCNaverMapPolylineCls}, // 0

    {"RNCNaverMapView", RNCNaverMapViewCls}, // 0
#endif
